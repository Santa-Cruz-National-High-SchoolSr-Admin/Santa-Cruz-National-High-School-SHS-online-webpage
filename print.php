...
$pdf->SetFont('Helvetica', 'B', 8);
$pdf->Cell(187, 5, "LAST SCHOOL YEAR (RETURNING LEARNER)
:", 1, 1, 'L');
...
$pdf->Ln(2);
$pdf->Cell(0, 0,"Issued on: " . $currentDate, 0, 1, 'L');
...
$pdf->MultiCell(0, 0,
    ...
    "Name: " . (isset($student['name']) ? $student['name'] : 'N/A') . "\n" .
...
$pdf->Ln(5); // Space before signature section
