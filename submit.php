...
$stmt_section->close();
    ...
    (grade, track, strand, section, learning_modality, school_year, lrn, first_name, middle_name, last_name, extension_name, dob, age, gender, birthplace, indigenous, mother_tongue, contact, 
